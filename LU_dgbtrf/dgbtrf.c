...
int main(int argc, char *argv[]) {
	...
	//double *a1 = (double *)calloc(size_a, sizeof(double));
	//double *a2 = (double *)calloc(size_a, sizeof(double));
	//double *a3 = (double *)calloc(size_a, sizeof(double));
	//double *a4 = (double *)calloc(size_a, sizeof(double));
	//double *a5 = (double *)calloc(size_a, sizeof(double));
	//double *a6 = (double *)calloc(size_a, sizeof(double));
	//double *a7 = (double *)calloc(size_a, sizeof(double));
	//double *a8 = (double *)calloc(size_a, sizeof(double));
	//double *a9 = (double *)calloc(size_a, sizeof(double));
        for (i=0; i<size_a; i++)
	...
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a1, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a2, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a3, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a4, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a5, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a6, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a7, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a8, lda, ipiv);
	//info = LAPACKE_dgbtrf(LAPACK_ROW_MAJOR, n, n, kl, ku, a9, lda, ipiv);
